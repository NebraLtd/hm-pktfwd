...
from pktfwd.utils import write_diagnostics, get_region_filename, replace_sx1301_global_conf_with_regional
...
class TestUtils(TestCase):
    ...
    def test_get_region_filename(self):
        self.assertEqual(get_region_filename("AS923_4"), "AS923-4-global_conf.json")
        self.assertEqual(get_region_filename("EU868"), "EU-global_conf.json")
        self.assertEqual(get_region_filename("US915"), "US-global_conf.json")
    ...
    def test_replace_sx1301_global_conf_with_regional(self):
        ...
        replace_sx1301_global_conf_with_regional(configs_dir, configs_dir, "IN865")
