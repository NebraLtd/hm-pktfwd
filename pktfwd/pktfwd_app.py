...
class PktfwdApp:
    def __init__(self, variant, region_override, region_filepath, sx1301_region_configs_dir, 
                ...
                reset_lgw_filepath, util_chip_id_filepath, 
                root_dir, 
    ...
    def start(self):
        ...
        update_global_conf(is_sx1302, self.root_dir, self.sx1301_region_configs_dir, self.sx1302_region_configs_dir, self.region, self.spi_bus)
        retry_start_concentrator(is_sx1302, self.spi_bus, self.sx1302_lora_pkt_fwd_filepath, self.sx1301_lora_pkt_fwd_dir,
                                self.reset_lgw_filepath, self.reset_pin)
    ...
    def prepare_to_start(self):
        ...
        run_reset_lgw(self.reset_lgw_filepath, self.reset_pin)
